...
//
// On Thu Jul 19 18:38:43 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkConnectionBox_16_10(CLK,
  ...
  // value method mux
  always@(dut_select_r or mux_in)
  begin
    case (dut_select_r)
      4'd0: mux = mux_in[15:0];
      4'd1: mux = mux_in[31:16];
      4'd2: mux = mux_in[47:32];
      4'd3: mux = mux_in[63:48];
      4'd4: mux = mux_in[79:64];
      4'd5: mux = mux_in[95:80];
      4'd6: mux = mux_in[111:96];
      4'd7: mux = mux_in[127:112];
      4'd8: mux = mux_in[143:128];
      4'd9: mux = mux_in[159:144];
